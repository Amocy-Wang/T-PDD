...
BADCC1=()
BADCC2=()
BADCC3=("/path/to/gcc-4.4.3/bin/gcc -O0" "/path/to/gcc-4.4.3/bin/gcc -O1" "/path/to/gcc-4.4.3/bin/gcc -O2" "/path/to/gcc-4.4.3/bin/gcc -O3" "/path/to/gcc-4.4.3/bin/gcc -Os")
MODE=""
