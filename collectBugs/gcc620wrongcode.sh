...
BADCC1=()
BADCC2=()
BADCC3=("/path/to/gcc-6.2.0/bin/gcc -O0" "/path/to/gcc-6.2.0/bin/gcc -O1" "/path/to/gcc-6.2.0/bin/gcc -O2" "/path/to/gcc-6.2.0/bin/gcc -O3" "/path/to/gcc-6.2.0/bin/gcc -Os")
MODE=""
