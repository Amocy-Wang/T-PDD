...
BADCC1=()
BADCC2=()
BADCC3=("/path/to/gccs/gcc-4.5.0/bin/gcc -O0" "/path/to/gccs/gcc-4.5.0/bin/gcc -O1" "/path/to/gccs/gcc-4.5.0/bin/gcc -O2" "/path/to/gccs/gcc-4.5.0/bin/gcc -O3" "/path/to/gccs/gcc-4.5.0/bin/gcc -Os")
MODE=""
